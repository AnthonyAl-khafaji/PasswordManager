...
class LoginScreen:
    ...
    def buildGui(self):
        ...
        bannerLabel = tk.Label(bannerFrame, text="Welcome to Our Secure Login", 
                                font=("Helvetica", 16, "bold"), fg="white", bg="#336699")
        ...
        loginButton = tk.Button(buttonFrame, text="Login", command=self.loginProcess, 
                              width=12, height=1, bg="#4CAF50", fg="white", relief="raised")
        loginButton.grid(row=0, column=0, padx=5)

        createButton = tk.Button(buttonFrame, text="Create New User", command=self.createNewUser, 
                               width=15, height=1, bg="#2196F3", fg="white", relief="raised")
    ...
    def loginProcess(self):
        ...
        if not valid:
            ...
            return False
        hashPW = self.db.GetPassHash(username)
